                ...
                if (pokemonIndex < nombresPokemonSeleccionados.size()) {
                    ...
                    try {
                        ...
                        if (url != null) {
                            ...
                            float escala = Math.min((float) POKEMON_WIDTH / iconoOriginal.getIconWidth(), 
                                                  (float) POKEMON_HEIGHT / iconoOriginal.getIconHeight());
        ...
        comboBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, 
                ...
                if (value != null) {
                    ...
                    if (m != null) {
                        setToolTipText(String.format("Tipo: %s | Potencia: %d | Precisión: %d%%", 
                            m.getTipo(), m.getPotencia(), m.getPrecision()));
                    }
                }
                return this;
            }
            ...
            for (String nombre : nombresPokemonSeleccionados) {
                ...
                if (pokemonReal != null) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(this,
                            "Error al asignar movimientos a " + nombre + ":\n" + ex.getMessage(),
                            "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
